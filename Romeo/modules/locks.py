...
import Romeo.modules.sql.locks_sql as sql
from Romeo import dispatcher, DRAGONS, LOGGER
...
def lock(update, context) -> str:
    ...
    if (can_delete(chat, context.bot.id) or
        ...
        send_message(
            update.effective_message,
            "I am not administrator or haven't got enough rights. Give me all rights and try again.",
        )
