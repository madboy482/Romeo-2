...
import telegram
from Romeo import TIGERS, WOLVES, dispatcher
from Romeo.modules.disable import DisableAbleCommandHandler
from Romeo.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
from Romeo.modules.helper_funcs.extraction import (extract_text,
                                                          extract_user,
                                                          extract_user_and_text)
from Romeo.modules.helper_funcs.filters import CustomFilters
from Romeo.modules.helper_funcs.misc import split_message
from Romeo.modules.helper_funcs.string_handling import split_quotes
from Romeo.modules.log_channel import loggable
from Romeo.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Romeo's sticker
        keyboard = None
