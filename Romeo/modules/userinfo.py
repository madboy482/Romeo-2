...
from Romeo import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Romeo.__main__ import STATS, TOKEN, USER_INFO
import Romeo.modules.sql.userinfo_sql as sql
from Romeo.modules.disable import DisableAbleCommandHandler
from Romeo.modules.sql.global_bans_sql import is_user_gbanned
from Romeo.modules.sql.afk_sql import is_afk, check_afk_status
from Romeo.modules.sql.users_sql import get_user_num_chats
from Romeo.modules.helper_funcs.chat_status import sudo_plus
from Romeo.modules.helper_funcs.extraction import extract_user
from Romeo import telethn as RomeoTelethonClient, TIGERS, DRAGONS, DEMONS
